        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {featuredWork.map((item, index) => (
            <ScrollAnimator key={item.id} delay={100 * (index + 1)}>
              <Card className="group overflow-hidden h-full flex flex-col transition-shadow duration-300 hover:shadow-2xl border-transparent hover:border-primary/50 bg-card">
