export const studioData = {
    hero: {
        ...
        imageUrl: "https://images.unsplash.com/photo-1560421683-6856ea585c78?q=80&w=1174&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    },
    marqueeItems: [
    ...
    creativeProcess: {
        ...
        description: "From initial sketches to final renders, every project is nurtured with passion and precision. The studio is equipped for a range of digital and traditional mediums, allowing for a fluid workflow that bridges the physical and virtual worlds. This is where the magic happens.",
        imageUrl: 'https://images.unsplash.com/photo-1560421683-6856ea585c78?q=80&w=1174&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'
    }
};
