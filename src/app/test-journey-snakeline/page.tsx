...
import { TestJourneyTimeline } from '@/components/test-journey-timeline';
import { JourneyBottomNav } from '@/components/journey-bottom-nav';
import { journeyData } from '@/lib/data';

export default function TestJourneySnakelinePage() {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-background">
      ...
      <main className="flex-1 pt-16">
        <TestJourneyTimeline items={sortedJourneyData} />
      </main>
